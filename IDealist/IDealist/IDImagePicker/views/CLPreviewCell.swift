...
class CLPreviewCell: UICollectionViewCell {
                        ...
                        if imageData != nil {
                            ...
                            if info != nil {
                                ...
                                if urlstr.contains(".gif") || urlstr.contains(".GIF") {
                                    ...
                                    self.model.img = UIImage.init(data: imageData!)
                                }
                            }
                        }
                    })
    ...
    var currentIndex: Int = 0 {
        didSet {
            if currentIndex == self.model.index {
                self.iconView.layer.borderWidth = 2
                self.iconView.layer.borderColor = CLPickersTools.instence.tineColor.cgColor
            } else {
                self.iconView.layer.borderWidth = 0
            }
            self.iconView.contentMode = .scaleAspectFill
            self.circleBtn?.isHidden = true
        }
    }
